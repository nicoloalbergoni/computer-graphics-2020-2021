...
function main() {
  ...
  //****** Use these variables for this exercise ******/
  var colour = [252.0/255.0, 186.0/255.0, 3.0/255.0];
  var colour_choice = 1.0;
  var second_colour = [29.0/255.0, 219.0/255.0];

  var colorLoc = gl.getUniformLocation(program, "u_colour");
  var colorChoiceLoc = gl.getUniformLocation(program, "colour_choice");
  var secondColorLoc = gl.getUniformLocation(program, "u_second_colour");
  ...
  gl.uniform3fv(colorLoc, colour);
  gl.uniform1f(colorChoiceLoc, colour_choice);
  gl.uniform2fv(secondColorLoc, second_colour);
